...
object ChatsRethink {
    ...
    fun insertNewChat(
        ...
        return  (itemInserted["generated_keys"] as ArrayList<String>)[0] //Id inserted
    }

    fun getChatsByUser(con: Connection, idUser: String): ArrayList<HashMap<*, *>> {
        val cursor =
            table.orderBy().optArg("index", r.desc("creation_time")).filter(r.hashMap("id_user",idUser))
...
//        val cursor =
//            table.get(idChat).run(con) as Cursor<HashMap<*, *>>
//        return cursor.next()
//    }
}
